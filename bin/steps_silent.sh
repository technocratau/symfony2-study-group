...
php app/console doctrine:generate:entity --entity=TechnocratLMSBundle:Course --format=yml --fields="name:string(255) cover:string(255)" --with-repository --no-interaction
